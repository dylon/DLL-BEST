(function(g){Function.prototype.inherits=function(c){var d=new c;if(d.__proto__===undefined)d.__proto__=d;d.__super__=c;this.prototype=d;this.prototype.constructor=this;return this};Function.prototype.extend=function(){var c,d,a,b,e,f;c=this.prototype;d=arguments;f=d.length;for(e=0;e<f;++e)if(a=d[e])for(b in a)if(a.hasOwnProperty(b))c[b]=a[b];return this};Function.prototype.namespace=function(c){c=c.split(".");for(var d=-1,a=g,b;b=c[++d];){b in a||(a[b]={});a=a[b]}this.__ns__=a;return this};Function.prototype.name=
function(c){this.__ns__[c]=this;this.__name__=c;return this};(function(){}).inherits(Object).namespace("DllBest").name("Base")})(this);(function(){(function(g,c){this.key=g;this.value=c}).inherits(DllBest.Base).namespace("DllBest").name("Node").extend({lChild:null,rChild:null,height:0,lt:null,gt:null,eq:null,assign:function(g,c){this.lChild=g.lChild;this.rChild=g.rChild;this.height=g.height;if(c){this.key=g.key;this.value=g.value;this.eq=g.eq}this.lt=g.lt;this.gt=g.gt;if(this.lt)this.lt.gt=this;if(this.gt)this.gt.lt=this},toString:function(){return"( "+this.key+" )"}})})(window);(function(g){(g.DllBest||(g.DllBest={})).Tree=function(c,d){this.N=c;this.compare=d}.inherits(DllBest.Base).extend({compare:null,height:function(){if(this.root)return this.root.height;return 0},biggest:function(){if(this.root)return this.findBiggest(this.root);return null},smallest:function(){if(this.root)return this.findSmallest(this.root);return null},N:null,root:null,elements:0,tryInsert:function(c,d){if(!this.root){this.root=new this.N(c,d);return true}if(!this.find(c)){this.addAsChild(this.root,
new this.N(c,d));this.elements+=1;return true}return false},put:function(c,d){var a=this.find(c);if(a)a.value=d;else this.insert(c,d)},insert:function(c,d){var a=new this.N(c,d);if(this.root){this.addAsChild(this.root,a);this.elements+=1}else this.root=a},findBiggest:function(c){for(;c.rChild;)c=c.rChild;return c},findSmallest:function(c){for(;c.lChild;)c=c.lChild;return c},preorder:function c(d,a){if(!d)d=this.root;a||(a=[]);if(!d)return a;a.push(d.value);for(var b=d;b=b.eq;)a.push(b.value);d.lChild&&
...
var b=this.compare(a,d.key);if(b<0)return c(d.lChild,a);if(b>0)return c(d.rChild,a);return d},remove:function(c){if(c=this.find(c)){this.removeNode(c);return true}return false},getRange:function(c,d){for(var a=[],b=this.root,e;b;){e=this.compare(b.key,c);if(e<0)b=b.rChild;else if(e>0&&b.lChild)b=b.lChild;else break}for(;b&&this.compare(b.key,d)<=0;){a.push(b.value);for(e=b;e=e.eq;)a.push(e.value);b=b.gt}return a},dlldump:function(){for(var c=this.smallest(),d=[],a;c;){d.push(c.value);for(a=c;a=a.eq;)d.push(a.value);
c=c.gt}return d},dequeue:function(){var c=this.biggest();if(c){this.removeNode(c);return c.value}return null}})})(window);(function(g){g=g.DllBest;(g.Avl||(g.Avl={})).Node=function(c,d){this.__super__(c,d)}.inherits(g.Node).extend({parent:null,isLeaf:function(){return this.height===0},isBranch:function(){var c=!!this.lChild,d=!!this.rChild;return c&&!d||!c&&d},maxChildHeight:function(){var c=this.lChild?this.lChild.height:-1,d=this.rChild?this.rChild.height:-1;return c>d?c:d},balance:function(){return(this.lChild?this.lChild.height:-1)-(this.rChild?this.rChild.height:-1)},isBalanced:function(){var c=this.balance();return c>=
-1&&c<=1},assign:function(c,d){this.__proto__.assign(c,d);this.parent=c.parent;if(this.lChild)this.lChild.parent=this;if(this.rChild)this.rChild.parent=this},toString:function(){return this.key+" ( "+this.height+" )"}})})(window);(function(g){g=g.DllBest;var c=g.Avl||(g.Avl={}),d=c.Node;c.Tree=function(a){this.__super__(d,a)}.inherits(g.Tree).extend({RRC:function(a,b,e,f){b=a.rChild;a.rChild=b.lChild;if(a.rChild)a.rChild.parent=a;b.lChild=a;a.parent=b;if(f){if(f.rChild===a)f.rChild=b;else f.lChild=b;b.parent=f}else{this.root=b;this.root.parent=null}this.recomputeHeights(a);this.recomputeHeights(b.parent)},RLC:function(a,b,e,f){b=a.rChild;e=b.lChild;b.lChild=e.rChild;if(b.lChild)b.lChild.parent=b;a.rChild=e.lChild;if(a.rChild)a.rChild.parent=
...
e)},recomputeHeights:function(a){for(var b=true;a&&b;){b=a.height;a.height=a.rChild||a.lChild?a.maxChildHeight()+1:0;b=a.height!==b;a=a.parent}},addAsChild:function(a,b){var e=null,f;f=this.compare(b.key,a.key);if(f<0)e=this.addLeftChild(a,b);else if(f>0)e=this.addRightChild(a,b);else this.addEqualChild(a,b);e&&this.rebalance(e)},addLeftChild:function(a,b){b.gt=a;var e=null,f;if(a.lChild)this.addAsChild(a.lChild,b);else{a.lChild=b;b.parent=a;if(a.lt)a.lt.gt=b;a.lt=b;if(a.height===0)for(f=a;f;){f.height=
...
a.parent)}},swapAndRemove:function(a){var b=this.findSmallest(a.rChild);this.swapNodes(a,b);a.height===0?this.removeLeaf(a):this.removeBranch(a)},swapNodes:function(a,b){var e=a.parent,f=a.lChild,i=a.rChild,h=b.parent,l=b.lChild,j=b.rChild,k;k=a.height;a.height=b.height;b.height=k;if(e){if(e.lChild===a)e.lChild=b;else e.rChild=b;b.parent=e}else{this.root=b;b.parent=null}b.lChild=f;f.parent=b;a.lChild=l;if(a.rChild=j)j.parent=a;else if(h!==a){b.rChild=i;i.parent=b;h.lChild=a;a.parent=h}else{b.rChild=
a;a.parent=b}}})})(window);
